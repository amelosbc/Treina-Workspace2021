...
create table tb_product (id bigint not null auto_increment, description varchar(255), image_url varchar(255), name varchar(255), price double precision, primary key (id)) engine=InnoDB;
